					...
					<div className="container py-md-3">
						...
						<div className="calltoaction-20-content row">
							...
							<div className="column ccont-left col-lg-6">
								...
								<p>
									We create an easy way to expand your business ideas.We understand the importance of branding for your business. Our task is to help you build an application in the way you imagine it. We as TechPledge here to help people make their business life much easier, through the applications. Mobile and web application development is our main mission in this soothing ocean.
								</p>
							</div>
						</div>
					</div>
