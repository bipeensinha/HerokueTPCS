					...
					<div className="container py-md-5">
						<div className="cwp4-two row">
							<div className="cwp4-text col-lg-6">
								...
								<p>
									Since 2015, we’ve been <b>developing web and mobile apps</b> that allow companies to automate business processes and grow profitability.
									After playing a comprehensive role in mobile app development in 2020, TechPledge Consulting is all set to continue spreading its magic in 2021 across globe.We know what the client wants and we know how to make it.We are Trusted by enterprises, startups, and everyone in between.
								</p>
